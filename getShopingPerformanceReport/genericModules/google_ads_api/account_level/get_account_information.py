...
def main(client, customer_id):
    ...
    # print("\t optimization_score_weight: ", str(customer.optimization_score_weight))
    # print("\t optimization_score: ", str(customer.optimization_score))
    # print("manager : ", customer.manager)
    # print("test_account : ", customer.test_account)
    # print('auto_tagging_enabled', customer.auto_tagging_enabled)
    # print('call_reporting_setting', customer.call_reporting_setting)
    print(customer)
