...
python remove_sitelink.py -c 4861039205 -f 156847180903
"""
...
def main(client, customer_id, feed_item_id):
    ...
    # Remove the extension feed item using the specified feed item ID
    extension_feed_item_operation.remove = extension_feed_item_service.extension_feed_item_path(
    ...
    try:
        ...
        print(
            "Removed extension feed item with resource name: "
